 ...
 * @author Alejandro
 */
public final class ControllerInitialFrame implements ActionListener {

    private final ViewInitialFrame initialFrame;
    private ViewFrameGame frameGame;
    private ControllerFrameGame controllerLogic;
    private static ModelLogic modelLogic;

    private int port;
    private String ip;

    public ControllerInitialFrame(ViewInitialFrame initialFrame) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (initialFrame.getTxtIP().getText().isEmpty()) {
            ...
            controllerLogic = new ControllerFrameGame(frameGame, modelLogic);
