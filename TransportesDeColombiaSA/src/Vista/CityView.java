 ...
 * @author Teban18
 */
public class CityView extends javax.swing.JDialog {

    /**
     * Creates new form CityView
     */
    public CityView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CityView dialog = new CityView(new javax.swing.JFrame(), true);
